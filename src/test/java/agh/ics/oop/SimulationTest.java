...
class SimulationTest {
    ...
    void oneAnimalRandomMovement(){
        ...
        Vector2d endPosition = new Vector2d(4, 2);
    ...
    void twoAnimalsRandomMovement(){
        ...
        assertEquals(animalOne.getOrientation(), MapDirection.NORTH);
    ...
    void fourAnimalsRandomMovement(){
        ...
        assertEquals(animalOne.getOrientation(), MapDirection.EAST);
        assertEquals(animalTwo.getOrientation(), MapDirection.NORTH);
        assertEquals(animalThree.getOrientation(), MapDirection.SOUTH);
        assertEquals(animalFour.getOrientation(), MapDirection.EAST);
